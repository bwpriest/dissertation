...
In Fig.~\ref{fig:degree_weak}, we see good weak scaling for NLNR beyond 32 compute nodes, at which point the system begins
...
We shall utilize Vigna's additive hyperbolic weighted $\tau_{h, \phi}$, is an extension to the well-studied Kendall's $\tau$ statistic \cite{vigna2015weighted}.
